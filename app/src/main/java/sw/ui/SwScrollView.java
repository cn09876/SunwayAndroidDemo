...
public class SwScrollView extends FrameLayout 
{
	...
	{  
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) 
        {
            ...
            {  
            	//right
                if(sw_on_zoom==null)return false;
            	sw_on_zoom.onFlyRight();
            }
    ...
    public void setOnZoomInOut(SwOnZoom onzoom)
    {
    	sw_on_zoom=onzoom;
    }
    ...
    public SwScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initScrollView() {
     ...
     // TODO remove comment when version changed to 2.2
            ...
            case MotionEvent.ACTION_MOVE:
            	if (mode >= 2) {  
                    ...
                    if (newDist > oldDist + 1) {  
                    	sw_on_zoom.onZoomInOut(1, newDist / oldDist);
                    	l("放大"+(newDist / oldDist));  
                        oldDist = newDist;  
                    }  
                    if (newDist < oldDist - 1) {  
                    	sw_on_zoom.onZoomInOut(0, newDist / oldDist);
                        l("缩小"+(newDist / oldDist));  
                        oldDist = newDist;  
                    }  
            	}
